...
create policy "authenticated can select gthb_repo_and_gthb_repo_topic"
  ...
  using (true);
create policy "authenticated can select discord_invite"
  on discord_invite for select to authenticated
  using (true);

create policy "authenticated can select proj_repo_and_discord_invite"
  on proj_repo_and_discord_invite for select to authenticated
  using (true);
