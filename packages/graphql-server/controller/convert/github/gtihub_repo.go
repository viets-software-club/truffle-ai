...
func ConvertGithubRepo(repo *githubApi.GetRepository, forkHist *[]githubApi.Hist, issueHist *[]githubApi.Hist, starHist *[]githubApi.Hist, contributorsToUsers *map[*githubv3.Contributor]*githubApi.GetUser) (*types.T_f_insert_gthb_repo, error) {
