...
type ComplexityRoot struct {
	...
	Query struct {
		...
		SuggestedCategoriesForProjRepo func(childComplexity int, projRepoID int) int
	}
}
...
type QueryResolver interface {
	...
	SuggestedCategoriesForProjRepo(ctx context.Context, projRepoID int) ([]string, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.createBookmark":
		...
		return e.complexity.Mutation.CreateBookmark(childComplexity, args["repo"].(model.RepositoryInput), args["categories"].([]string)), true
	...
	case "Query.suggestedCategoriesForProjRepo":
		if e.complexity.Query.SuggestedCategoriesForProjRepo == nil {
			break
		}

		args, err := ec.field_Query_suggestedCategoriesForProjRepo_args(context.TODO(), rawArgs)
		if err != nil {
			return 0, false
		}

		return e.complexity.Query.SuggestedCategoriesForProjRepo(childComplexity, args["projRepoId"].(int)), true
...
func (ec *executionContext) field_Query_suggestedCategoriesForProjRepo_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	var err error
	args := map[string]interface{}{}
	var arg0 int
	if tmp, ok := rawArgs["projRepoId"]; ok {
...
func (ec *executionContext) _Mutation_createBookmark(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		return ec.resolvers.Mutation().CreateBookmark(rctx, fc.Args["repo"].(model.RepositoryInput), fc.Args["categories"].([]string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Query_suggestedCategoriesForProjRepo(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_Query_suggestedCategoriesForProjRepo(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().SuggestedCategoriesForProjRepo(rctx, fc.Args["projRepoId"].(int))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) fieldContext_Query_suggestedCategoriesForProjRepo(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Query",
		Field:      field,
		IsMethod:   true,
	...
	ctx = graphql.WithFieldContext(ctx, fc)
	if fc.Args, err = ec.field_Query_suggestedCategoriesForProjRepo_args(ctx, field.ArgumentMap(ec.Variables)); err != nil {
		ec.Error(ctx, err)
		return fc, err
	}
	return fc, nil
...
func (ec *executionContext) unmarshalInputRepositoryInput(ctx context.Context, obj interface{}) (model.RepositoryInput, error) {
	...
	fieldsInOrder := [...]string{"owner", "name"}
...
func (ec *executionContext) _Query(ctx context.Context, sel ast.SelectionSet) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "suggestedCategoriesForProjRepo":
			field := field
			...
			innerFunc := func(ctx context.Context, fs *graphql.FieldSet) (res graphql.Marshaler) {
				...
				res = ec._Query_suggestedCategoriesForProjRepo(ctx, field)
				if res == graphql.Null {
					atomic.AddUint32(&fs.Invalids, 1)
				}
				return res
