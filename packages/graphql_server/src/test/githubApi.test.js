    ...
    return __generator(this, function (_c) {
      switch (_c.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            (0, githubApi_1.getRepositoryTopics)(
              repoFounder,
              repoName,
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [
            4 /*yield*/,
            (0, githubApi_1.getContributors)(owner, repo)
              .then(function (contributors) {
                console.log(
                  'Contributors f\u00FCr das Repository '.concat(owner, '/').concat(repo, ':')
                )
                contributors.forEach(function (contributor, index) {
                  console.log(
                    ''
                      .concat(index + 1, '. ')
                      .concat(contributor.login, ' (')
                      .concat(contributor.contributions, ' Beitrag/Betr\u00E4ge)')
                  )
                })
              })
