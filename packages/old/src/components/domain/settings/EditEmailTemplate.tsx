...
const EditEmailTemplate = () => {
	const [email, setEmail] = useState(
		(typeof window !== 'undefined' && localStorage.getItem('emailMessage')) ||
			initialTemplate
	)
	...
	return (
		<>
			<p className="mb-6 text-sm font-normal text-white/75">
				Here, you have the option to customize the email template that will be
				automatically sent to the founders of a project on its detail page.
				<br /> Use {'{founderName}'} and {'{projectName}'} as placeholders for
				the actual values.
			</p>
			<Textarea
