...
import Section from '@/components/pure/PageSection'
	...
	return (
		<div className="flex flex-col">
			...
			<div className="w-full px-6 py-4 text-white lg:ml-64 lg:w-auto lg:p-10 xl:px-20">
				<h2 className="border-b border-white/5 pb-4 text-xl font-medium lg:mt-8">
					General
				</h2>
				...
				<h2 className="mt-8 border-b border-white/5 pb-4 text-xl font-medium">
					Account
				</h2>
