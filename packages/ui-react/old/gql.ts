...
export type ProjectIdsQuery = {
	...
	projectCollection?: {
		...
		edges: Array<{
			__typename?: 'ProjectEdge'
			node: { __typename?: 'Project'; id: any }
		}>
	} | null
}
...
export function useAddProjectByUrlMutation() {
	return Urql.useMutation<
		AddProjectByUrlMutation,
		AddProjectByUrlMutationVariables
...
export function useEditBookmarkCategoryMutation() {
	return Urql.useMutation<
		EditBookmarkCategoryMutation,
		EditBookmarkCategoryMutationVariables
...
export function useRenameBookmarkCategoryMutation() {
	return Urql.useMutation<
		RenameBookmarkCategoryMutation,
		RenameBookmarkCategoryMutationVariables
