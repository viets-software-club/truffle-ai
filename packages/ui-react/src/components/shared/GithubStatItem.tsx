...
const getColor = (
  ...
  if (!value || !greenValue || !lightGreenValue || !redValue || !lightRedValue) return Color.DEFAULT
...
const GithubStatItem = ({
  ...
  const color = getColor(value, greenValue, lightGreenValue, redValue, lightRedValue, reverseStats)
