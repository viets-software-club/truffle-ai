...
export type DetailViewProjRepoTopQuery = { __typename?: 'Query', projRepoCollection?: { __typename?: 'ProjRepoConnection', edges: Array<{ __typename?: 'ProjRepoEdge', node: { __typename?: 'ProjRepo', algoHnEli5?: string | null } }> } | null };
...
export type ListTrendingGthbRepoQuery = { __typename?: 'Query', fListTrendingGthbRepo?: { __typename?: 'GthbRepoConnection', edges: Array<{ __typename?: 'GthbRepoEdge', node: { __typename?: 'GthbRepo', gthbRepoName: string, gthbRepoDescription?: string | null, stargazerCount: any, issuesTotalCount: any, forksPerContributor: any, forkCount: any, contributorCount: any, issuesPerContributor: any, pullRequestsTotalCount: any, gthbOwner: { __typename?: 'GthbOwner', avatarUrl: string, gthbOwnerLogin: string }, gthbRepo: { __typename?: 'ProjRepo', projRepoId: any } } }> } | null };
...
export const DetailViewProjRepoTopDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"DetailViewProjRepoTop"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"BigInt"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"gthbStarHistFilter"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"GthbStarHistFilter"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"gthbIssueHistFilter"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"GthbIssueHistFilter"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"gthbForkHistFilter"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"GthbForkHistFilter"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"projRepoCollection"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"filter"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"gthbRepoId"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"eq"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}]}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"edges"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"node"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"algoHnEli5"}}]}}]}}]}}]}}]} as unknown as DocumentNode<DetailViewProjRepoTopQuery, DetailViewProjRepoTopQueryVariables>;
...
export const UpdateNotesForProjRepoDocument = gql`
  ...
  updateProjRepoCollection(filter: {projRepoId: {eq: $id}}, set: {note: $text}) {
    ...
    `;
export type UpdateNotesForProjRepoMutationFn = Apollo.MutationFunction<UpdateNotesForProjRepoMutation, UpdateNotesForProjRepoMutationVariables>;
 ...
 * });
 */
export function useUpdateNotesForProjRepoMutation(baseOptions?: Apollo.MutationHookOptions<UpdateNotesForProjRepoMutation, UpdateNotesForProjRepoMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateNotesForProjRepoMutation, UpdateNotesForProjRepoMutationVariables>(UpdateNotesForProjRepoDocument, options);
      }
export type UpdateNotesForProjRepoMutationHookResult = ReturnType<typeof useUpdateNotesForProjRepoMutation>;
export type UpdateNotesForProjRepoMutationResult = Apollo.MutationResult<UpdateNotesForProjRepoMutation>;
export type UpdateNotesForProjRepoMutationOptions = Apollo.BaseMutationOptions<UpdateNotesForProjRepoMutation, UpdateNotesForProjRepoMutationVariables>;
 ...
 * });
 */
export function useAllAlgoHnCommentAndAlgoHnTagQuery(baseOptions?: Apollo.QueryHookOptions<AllAlgoHnCommentAndAlgoHnTagQuery, AllAlgoHnCommentAndAlgoHnTagQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<AllAlgoHnCommentAndAlgoHnTagQuery, AllAlgoHnCommentAndAlgoHnTagQueryVariables>(AllAlgoHnCommentAndAlgoHnTagDocument, options);
      }
export function useAllAlgoHnCommentAndAlgoHnTagLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<AllAlgoHnCommentAndAlgoHnTagQuery, AllAlgoHnCommentAndAlgoHnTagQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<AllAlgoHnCommentAndAlgoHnTagQuery, AllAlgoHnCommentAndAlgoHnTagQueryVariables>(AllAlgoHnCommentAndAlgoHnTagDocument, options);
        }
export function useAllAlgoHnCommentAndAlgoHnTagSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<AllAlgoHnCommentAndAlgoHnTagQuery, AllAlgoHnCommentAndAlgoHnTagQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<AllAlgoHnCommentAndAlgoHnTagQuery, AllAlgoHnCommentAndAlgoHnTagQueryVariables>(AllAlgoHnCommentAndAlgoHnTagDocument, options);
        }
export type AllAlgoHnCommentAndAlgoHnTagQueryHookResult = ReturnType<typeof useAllAlgoHnCommentAndAlgoHnTagQuery>;
export type AllAlgoHnCommentAndAlgoHnTagLazyQueryHookResult = ReturnType<typeof useAllAlgoHnCommentAndAlgoHnTagLazyQuery>;
export type AllAlgoHnCommentAndAlgoHnTagSuspenseQueryHookResult = ReturnType<typeof useAllAlgoHnCommentAndAlgoHnTagSuspenseQuery>;
export type AllAlgoHnCommentAndAlgoHnTagQueryResult = Apollo.QueryResult<AllAlgoHnCommentAndAlgoHnTagQuery, AllAlgoHnCommentAndAlgoHnTagQueryVariables>;
 ...
 * });
 */
export function useAllAlgoHnQueryQuery(baseOptions?: Apollo.QueryHookOptions<AllAlgoHnQueryQuery, AllAlgoHnQueryQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<AllAlgoHnQueryQuery, AllAlgoHnQueryQueryVariables>(AllAlgoHnQueryDocument, options);
      }
export function useAllAlgoHnQueryLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<AllAlgoHnQueryQuery, AllAlgoHnQueryQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<AllAlgoHnQueryQuery, AllAlgoHnQueryQueryVariables>(AllAlgoHnQueryDocument, options);
        }
export function useAllAlgoHnQuerySuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<AllAlgoHnQueryQuery, AllAlgoHnQueryQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<AllAlgoHnQueryQuery, AllAlgoHnQueryQueryVariables>(AllAlgoHnQueryDocument, options);
        }
export type AllAlgoHnQueryQueryHookResult = ReturnType<typeof useAllAlgoHnQueryQuery>;
export type AllAlgoHnQueryLazyQueryHookResult = ReturnType<typeof useAllAlgoHnQueryLazyQuery>;
export type AllAlgoHnQuerySuspenseQueryHookResult = ReturnType<typeof useAllAlgoHnQuerySuspenseQuery>;
export type AllAlgoHnQueryQueryResult = Apollo.QueryResult<AllAlgoHnQueryQuery, AllAlgoHnQueryQueryVariables>;
 ...
 * });
 */
export function useAllAlgoHnStoryQuery(baseOptions?: Apollo.QueryHookOptions<AllAlgoHnStoryQuery, AllAlgoHnStoryQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<AllAlgoHnStoryQuery, AllAlgoHnStoryQueryVariables>(AllAlgoHnStoryDocument, options);
      }
export function useAllAlgoHnStoryLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<AllAlgoHnStoryQuery, AllAlgoHnStoryQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<AllAlgoHnStoryQuery, AllAlgoHnStoryQueryVariables>(AllAlgoHnStoryDocument, options);
        }
export function useAllAlgoHnStorySuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<AllAlgoHnStoryQuery, AllAlgoHnStoryQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<AllAlgoHnStoryQuery, AllAlgoHnStoryQueryVariables>(AllAlgoHnStoryDocument, options);
        }
export type AllAlgoHnStoryQueryHookResult = ReturnType<typeof useAllAlgoHnStoryQuery>;
export type AllAlgoHnStoryLazyQueryHookResult = ReturnType<typeof useAllAlgoHnStoryLazyQuery>;
export type AllAlgoHnStorySuspenseQueryHookResult = ReturnType<typeof useAllAlgoHnStorySuspenseQuery>;
export type AllAlgoHnStoryQueryResult = Apollo.QueryResult<AllAlgoHnStoryQuery, AllAlgoHnStoryQueryVariables>;
 ...
 * });
 */
export function useAllAlgoHnTagQuery(baseOptions?: Apollo.QueryHookOptions<AllAlgoHnTagQuery, AllAlgoHnTagQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<AllAlgoHnTagQuery, AllAlgoHnTagQueryVariables>(AllAlgoHnTagDocument, options);
      }
export function useAllAlgoHnTagLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<AllAlgoHnTagQuery, AllAlgoHnTagQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<AllAlgoHnTagQuery, AllAlgoHnTagQueryVariables>(AllAlgoHnTagDocument, options);
        }
export function useAllAlgoHnTagSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<AllAlgoHnTagQuery, AllAlgoHnTagQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<AllAlgoHnTagQuery, AllAlgoHnTagQueryVariables>(AllAlgoHnTagDocument, options);
        }
export type AllAlgoHnTagQueryHookResult = ReturnType<typeof useAllAlgoHnTagQuery>;
export type AllAlgoHnTagLazyQueryHookResult = ReturnType<typeof useAllAlgoHnTagLazyQuery>;
export type AllAlgoHnTagSuspenseQueryHookResult = ReturnType<typeof useAllAlgoHnTagSuspenseQuery>;
export type AllAlgoHnTagQueryResult = Apollo.QueryResult<AllAlgoHnTagQuery, AllAlgoHnTagQueryVariables>;
 ...
 * });
 */
export function useAllGthbForkHistQuery(baseOptions?: Apollo.QueryHookOptions<AllGthbForkHistQuery, AllGthbForkHistQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<AllGthbForkHistQuery, AllGthbForkHistQueryVariables>(AllGthbForkHistDocument, options);
      }
export function useAllGthbForkHistLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<AllGthbForkHistQuery, AllGthbForkHistQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<AllGthbForkHistQuery, AllGthbForkHistQueryVariables>(AllGthbForkHistDocument, options);
        }
export function useAllGthbForkHistSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<AllGthbForkHistQuery, AllGthbForkHistQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<AllGthbForkHistQuery, AllGthbForkHistQueryVariables>(AllGthbForkHistDocument, options);
        }
export type AllGthbForkHistQueryHookResult = ReturnType<typeof useAllGthbForkHistQuery>;
export type AllGthbForkHistLazyQueryHookResult = ReturnType<typeof useAllGthbForkHistLazyQuery>;
export type AllGthbForkHistSuspenseQueryHookResult = ReturnType<typeof useAllGthbForkHistSuspenseQuery>;
export type AllGthbForkHistQueryResult = Apollo.QueryResult<AllGthbForkHistQuery, AllGthbForkHistQueryVariables>;
 ...
 * });
 */
export function useAllGthbIssueHistQuery(baseOptions?: Apollo.QueryHookOptions<AllGthbIssueHistQuery, AllGthbIssueHistQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<AllGthbIssueHistQuery, AllGthbIssueHistQueryVariables>(AllGthbIssueHistDocument, options);
      }
export function useAllGthbIssueHistLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<AllGthbIssueHistQuery, AllGthbIssueHistQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<AllGthbIssueHistQuery, AllGthbIssueHistQueryVariables>(AllGthbIssueHistDocument, options);
        }
export function useAllGthbIssueHistSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<AllGthbIssueHistQuery, AllGthbIssueHistQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<AllGthbIssueHistQuery, AllGthbIssueHistQueryVariables>(AllGthbIssueHistDocument, options);
        }
export type AllGthbIssueHistQueryHookResult = ReturnType<typeof useAllGthbIssueHistQuery>;
export type AllGthbIssueHistLazyQueryHookResult = ReturnType<typeof useAllGthbIssueHistLazyQuery>;
export type AllGthbIssueHistSuspenseQueryHookResult = ReturnType<typeof useAllGthbIssueHistSuspenseQuery>;
export type AllGthbIssueHistQueryResult = Apollo.QueryResult<AllGthbIssueHistQuery, AllGthbIssueHistQueryVariables>;
 ...
 * });
 */
export function useAllGthbRepoContributorQuery(baseOptions?: Apollo.QueryHookOptions<AllGthbRepoContributorQuery, AllGthbRepoContributorQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<AllGthbRepoContributorQuery, AllGthbRepoContributorQueryVariables>(AllGthbRepoContributorDocument, options);
      }
export function useAllGthbRepoContributorLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<AllGthbRepoContributorQuery, AllGthbRepoContributorQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<AllGthbRepoContributorQuery, AllGthbRepoContributorQueryVariables>(AllGthbRepoContributorDocument, options);
        }
export function useAllGthbRepoContributorSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<AllGthbRepoContributorQuery, AllGthbRepoContributorQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<AllGthbRepoContributorQuery, AllGthbRepoContributorQueryVariables>(AllGthbRepoContributorDocument, options);
        }
export type AllGthbRepoContributorQueryHookResult = ReturnType<typeof useAllGthbRepoContributorQuery>;
export type AllGthbRepoContributorLazyQueryHookResult = ReturnType<typeof useAllGthbRepoContributorLazyQuery>;
export type AllGthbRepoContributorSuspenseQueryHookResult = ReturnType<typeof useAllGthbRepoContributorSuspenseQuery>;
export type AllGthbRepoContributorQueryResult = Apollo.QueryResult<AllGthbRepoContributorQuery, AllGthbRepoContributorQueryVariables>;
 ...
 * });
 */
export function useAllGthbRepoTopicQuery(baseOptions?: Apollo.QueryHookOptions<AllGthbRepoTopicQuery, AllGthbRepoTopicQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<AllGthbRepoTopicQuery, AllGthbRepoTopicQueryVariables>(AllGthbRepoTopicDocument, options);
      }
export function useAllGthbRepoTopicLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<AllGthbRepoTopicQuery, AllGthbRepoTopicQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<AllGthbRepoTopicQuery, AllGthbRepoTopicQueryVariables>(AllGthbRepoTopicDocument, options);
        }
export function useAllGthbRepoTopicSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<AllGthbRepoTopicQuery, AllGthbRepoTopicQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<AllGthbRepoTopicQuery, AllGthbRepoTopicQueryVariables>(AllGthbRepoTopicDocument, options);
        }
export type AllGthbRepoTopicQueryHookResult = ReturnType<typeof useAllGthbRepoTopicQuery>;
export type AllGthbRepoTopicLazyQueryHookResult = ReturnType<typeof useAllGthbRepoTopicLazyQuery>;
export type AllGthbRepoTopicSuspenseQueryHookResult = ReturnType<typeof useAllGthbRepoTopicSuspenseQuery>;
export type AllGthbRepoTopicQueryResult = Apollo.QueryResult<AllGthbRepoTopicQuery, AllGthbRepoTopicQueryVariables>;
 ...
 * });
 */
export function useAllGthbTrendingQuery(baseOptions?: Apollo.QueryHookOptions<AllGthbTrendingQuery, AllGthbTrendingQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<AllGthbTrendingQuery, AllGthbTrendingQueryVariables>(AllGthbTrendingDocument, options);
      }
export function useAllGthbTrendingLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<AllGthbTrendingQuery, AllGthbTrendingQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<AllGthbTrendingQuery, AllGthbTrendingQueryVariables>(AllGthbTrendingDocument, options);
        }
export function useAllGthbTrendingSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<AllGthbTrendingQuery, AllGthbTrendingQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<AllGthbTrendingQuery, AllGthbTrendingQueryVariables>(AllGthbTrendingDocument, options);
        }
export type AllGthbTrendingQueryHookResult = ReturnType<typeof useAllGthbTrendingQuery>;
export type AllGthbTrendingLazyQueryHookResult = ReturnType<typeof useAllGthbTrendingLazyQuery>;
export type AllGthbTrendingSuspenseQueryHookResult = ReturnType<typeof useAllGthbTrendingSuspenseQuery>;
export type AllGthbTrendingQueryResult = Apollo.QueryResult<AllGthbTrendingQuery, AllGthbTrendingQueryVariables>;
 ...
 * });
 */
export function useAllGthbUserQuery(baseOptions?: Apollo.QueryHookOptions<AllGthbUserQuery, AllGthbUserQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<AllGthbUserQuery, AllGthbUserQueryVariables>(AllGthbUserDocument, options);
      }
export function useAllGthbUserLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<AllGthbUserQuery, AllGthbUserQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<AllGthbUserQuery, AllGthbUserQueryVariables>(AllGthbUserDocument, options);
        }
export function useAllGthbUserSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<AllGthbUserQuery, AllGthbUserQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<AllGthbUserQuery, AllGthbUserQueryVariables>(AllGthbUserDocument, options);
        }
export type AllGthbUserQueryHookResult = ReturnType<typeof useAllGthbUserQuery>;
export type AllGthbUserLazyQueryHookResult = ReturnType<typeof useAllGthbUserLazyQuery>;
export type AllGthbUserSuspenseQueryHookResult = ReturnType<typeof useAllGthbUserSuspenseQuery>;
export type AllGthbUserQueryResult = Apollo.QueryResult<AllGthbUserQuery, AllGthbUserQueryVariables>;
 ...
 * });
 */
export function useAllProjCatQuery(baseOptions?: Apollo.QueryHookOptions<AllProjCatQuery, AllProjCatQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<AllProjCatQuery, AllProjCatQueryVariables>(AllProjCatDocument, options);
      }
export function useAllProjCatLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<AllProjCatQuery, AllProjCatQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<AllProjCatQuery, AllProjCatQueryVariables>(AllProjCatDocument, options);
        }
export function useAllProjCatSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<AllProjCatQuery, AllProjCatQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<AllProjCatQuery, AllProjCatQueryVariables>(AllProjCatDocument, options);
        }
export type AllProjCatQueryHookResult = ReturnType<typeof useAllProjCatQuery>;
export type AllProjCatLazyQueryHookResult = ReturnType<typeof useAllProjCatLazyQuery>;
export type AllProjCatSuspenseQueryHookResult = ReturnType<typeof useAllProjCatSuspenseQuery>;
export type AllProjCatQueryResult = Apollo.QueryResult<AllProjCatQuery, AllProjCatQueryVariables>;
 ...
 * });
 */
export function useAllProjRepoQuery(baseOptions?: Apollo.QueryHookOptions<AllProjRepoQuery, AllProjRepoQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<AllProjRepoQuery, AllProjRepoQueryVariables>(AllProjRepoDocument, options);
      }
export function useAllProjRepoLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<AllProjRepoQuery, AllProjRepoQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<AllProjRepoQuery, AllProjRepoQueryVariables>(AllProjRepoDocument, options);
        }
export function useAllProjRepoSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<AllProjRepoQuery, AllProjRepoQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<AllProjRepoQuery, AllProjRepoQueryVariables>(AllProjRepoDocument, options);
        }
export type AllProjRepoQueryHookResult = ReturnType<typeof useAllProjRepoQuery>;
export type AllProjRepoLazyQueryHookResult = ReturnType<typeof useAllProjRepoLazyQuery>;
export type AllProjRepoSuspenseQueryHookResult = ReturnType<typeof useAllProjRepoSuspenseQuery>;
export type AllProjRepoQueryResult = Apollo.QueryResult<AllProjRepoQuery, AllProjRepoQueryVariables>;
 ...
 * });
 */
export function useAllProjRepoAndProjClassifierQuery(baseOptions?: Apollo.QueryHookOptions<AllProjRepoAndProjClassifierQuery, AllProjRepoAndProjClassifierQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<AllProjRepoAndProjClassifierQuery, AllProjRepoAndProjClassifierQueryVariables>(AllProjRepoAndProjClassifierDocument, options);
      }
export function useAllProjRepoAndProjClassifierLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<AllProjRepoAndProjClassifierQuery, AllProjRepoAndProjClassifierQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<AllProjRepoAndProjClassifierQuery, AllProjRepoAndProjClassifierQueryVariables>(AllProjRepoAndProjClassifierDocument, options);
        }
export function useAllProjRepoAndProjClassifierSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<AllProjRepoAndProjClassifierQuery, AllProjRepoAndProjClassifierQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<AllProjRepoAndProjClassifierQuery, AllProjRepoAndProjClassifierQueryVariables>(AllProjRepoAndProjClassifierDocument, options);
        }
export type AllProjRepoAndProjClassifierQueryHookResult = ReturnType<typeof useAllProjRepoAndProjClassifierQuery>;
export type AllProjRepoAndProjClassifierLazyQueryHookResult = ReturnType<typeof useAllProjRepoAndProjClassifierLazyQuery>;
export type AllProjRepoAndProjClassifierSuspenseQueryHookResult = ReturnType<typeof useAllProjRepoAndProjClassifierSuspenseQuery>;
export type AllProjRepoAndProjClassifierQueryResult = Apollo.QueryResult<AllProjRepoAndProjClassifierQuery, AllProjRepoAndProjClassifierQueryVariables>;
 ...
 * });
 */
export function useAllProjRepoAndSbotLinCompanyQuery(baseOptions?: Apollo.QueryHookOptions<AllProjRepoAndSbotLinCompanyQuery, AllProjRepoAndSbotLinCompanyQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<AllProjRepoAndSbotLinCompanyQuery, AllProjRepoAndSbotLinCompanyQueryVariables>(AllProjRepoAndSbotLinCompanyDocument, options);
      }
export function useAllProjRepoAndSbotLinCompanyLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<AllProjRepoAndSbotLinCompanyQuery, AllProjRepoAndSbotLinCompanyQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<AllProjRepoAndSbotLinCompanyQuery, AllProjRepoAndSbotLinCompanyQueryVariables>(AllProjRepoAndSbotLinCompanyDocument, options);
        }
export function useAllProjRepoAndSbotLinCompanySuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<AllProjRepoAndSbotLinCompanyQuery, AllProjRepoAndSbotLinCompanyQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<AllProjRepoAndSbotLinCompanyQuery, AllProjRepoAndSbotLinCompanyQueryVariables>(AllProjRepoAndSbotLinCompanyDocument, options);
        }
export type AllProjRepoAndSbotLinCompanyQueryHookResult = ReturnType<typeof useAllProjRepoAndSbotLinCompanyQuery>;
export type AllProjRepoAndSbotLinCompanyLazyQueryHookResult = ReturnType<typeof useAllProjRepoAndSbotLinCompanyLazyQuery>;
export type AllProjRepoAndSbotLinCompanySuspenseQueryHookResult = ReturnType<typeof useAllProjRepoAndSbotLinCompanySuspenseQuery>;
export type AllProjRepoAndSbotLinCompanyQueryResult = Apollo.QueryResult<AllProjRepoAndSbotLinCompanyQuery, AllProjRepoAndSbotLinCompanyQueryVariables>;
 ...
 * });
 */
export function useAllProjRepoAndSbotLinProfileQuery(baseOptions?: Apollo.QueryHookOptions<AllProjRepoAndSbotLinProfileQuery, AllProjRepoAndSbotLinProfileQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<AllProjRepoAndSbotLinProfileQuery, AllProjRepoAndSbotLinProfileQueryVariables>(AllProjRepoAndSbotLinProfileDocument, options);
      }
export function useAllProjRepoAndSbotLinProfileLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<AllProjRepoAndSbotLinProfileQuery, AllProjRepoAndSbotLinProfileQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<AllProjRepoAndSbotLinProfileQuery, AllProjRepoAndSbotLinProfileQueryVariables>(AllProjRepoAndSbotLinProfileDocument, options);
        }
export function useAllProjRepoAndSbotLinProfileSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<AllProjRepoAndSbotLinProfileQuery, AllProjRepoAndSbotLinProfileQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<AllProjRepoAndSbotLinProfileQuery, AllProjRepoAndSbotLinProfileQueryVariables>(AllProjRepoAndSbotLinProfileDocument, options);
        }
export type AllProjRepoAndSbotLinProfileQueryHookResult = ReturnType<typeof useAllProjRepoAndSbotLinProfileQuery>;
export type AllProjRepoAndSbotLinProfileLazyQueryHookResult = ReturnType<typeof useAllProjRepoAndSbotLinProfileLazyQuery>;
export type AllProjRepoAndSbotLinProfileSuspenseQueryHookResult = ReturnType<typeof useAllProjRepoAndSbotLinProfileSuspenseQuery>;
export type AllProjRepoAndSbotLinProfileQueryResult = Apollo.QueryResult<AllProjRepoAndSbotLinProfileQuery, AllProjRepoAndSbotLinProfileQueryVariables>;
 ...
 * });
 */
export function useDetailViewForkHistQuery(baseOptions?: Apollo.QueryHookOptions<DetailViewForkHistQuery, DetailViewForkHistQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<DetailViewForkHistQuery, DetailViewForkHistQueryVariables>(DetailViewForkHistDocument, options);
      }
export function useDetailViewForkHistLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<DetailViewForkHistQuery, DetailViewForkHistQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<DetailViewForkHistQuery, DetailViewForkHistQueryVariables>(DetailViewForkHistDocument, options);
        }
export function useDetailViewForkHistSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<DetailViewForkHistQuery, DetailViewForkHistQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<DetailViewForkHistQuery, DetailViewForkHistQueryVariables>(DetailViewForkHistDocument, options);
        }
export type DetailViewForkHistQueryHookResult = ReturnType<typeof useDetailViewForkHistQuery>;
export type DetailViewForkHistLazyQueryHookResult = ReturnType<typeof useDetailViewForkHistLazyQuery>;
export type DetailViewForkHistSuspenseQueryHookResult = ReturnType<typeof useDetailViewForkHistSuspenseQuery>;
export type DetailViewForkHistQueryResult = Apollo.QueryResult<DetailViewForkHistQuery, DetailViewForkHistQueryVariables>;
 ...
 * });
 */
export function useDetailViewProjRepoTopQuery(baseOptions?: Apollo.QueryHookOptions<DetailViewProjRepoTopQuery, DetailViewProjRepoTopQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<DetailViewProjRepoTopQuery, DetailViewProjRepoTopQueryVariables>(DetailViewProjRepoTopDocument, options);
      }
export function useDetailViewProjRepoTopLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<DetailViewProjRepoTopQuery, DetailViewProjRepoTopQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<DetailViewProjRepoTopQuery, DetailViewProjRepoTopQueryVariables>(DetailViewProjRepoTopDocument, options);
        }
export function useDetailViewProjRepoTopSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<DetailViewProjRepoTopQuery, DetailViewProjRepoTopQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<DetailViewProjRepoTopQuery, DetailViewProjRepoTopQueryVariables>(DetailViewProjRepoTopDocument, options);
        }
export type DetailViewProjRepoTopQueryHookResult = ReturnType<typeof useDetailViewProjRepoTopQuery>;
export type DetailViewProjRepoTopLazyQueryHookResult = ReturnType<typeof useDetailViewProjRepoTopLazyQuery>;
export type DetailViewProjRepoTopSuspenseQueryHookResult = ReturnType<typeof useDetailViewProjRepoTopSuspenseQuery>;
export type DetailViewProjRepoTopQueryResult = Apollo.QueryResult<DetailViewProjRepoTopQuery, DetailViewProjRepoTopQueryVariables>;
 ...
 * });
 */
export function useListBookmarkedGthbRepoQuery(baseOptions?: Apollo.QueryHookOptions<ListBookmarkedGthbRepoQuery, ListBookmarkedGthbRepoQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<ListBookmarkedGthbRepoQuery, ListBookmarkedGthbRepoQueryVariables>(ListBookmarkedGthbRepoDocument, options);
      }
export function useListBookmarkedGthbRepoLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<ListBookmarkedGthbRepoQuery, ListBookmarkedGthbRepoQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<ListBookmarkedGthbRepoQuery, ListBookmarkedGthbRepoQueryVariables>(ListBookmarkedGthbRepoDocument, options);
        }
export function useListBookmarkedGthbRepoSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<ListBookmarkedGthbRepoQuery, ListBookmarkedGthbRepoQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<ListBookmarkedGthbRepoQuery, ListBookmarkedGthbRepoQueryVariables>(ListBookmarkedGthbRepoDocument, options);
        }
export type ListBookmarkedGthbRepoQueryHookResult = ReturnType<typeof useListBookmarkedGthbRepoQuery>;
export type ListBookmarkedGthbRepoLazyQueryHookResult = ReturnType<typeof useListBookmarkedGthbRepoLazyQuery>;
export type ListBookmarkedGthbRepoSuspenseQueryHookResult = ReturnType<typeof useListBookmarkedGthbRepoSuspenseQuery>;
export type ListBookmarkedGthbRepoQueryResult = Apollo.QueryResult<ListBookmarkedGthbRepoQuery, ListBookmarkedGthbRepoQueryVariables>;
 ...
 * });
 */
export function useListTrendingGthbRepoQuery(baseOptions?: Apollo.QueryHookOptions<ListTrendingGthbRepoQuery, ListTrendingGthbRepoQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<ListTrendingGthbRepoQuery, ListTrendingGthbRepoQueryVariables>(ListTrendingGthbRepoDocument, options);
      }
export function useListTrendingGthbRepoLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<ListTrendingGthbRepoQuery, ListTrendingGthbRepoQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<ListTrendingGthbRepoQuery, ListTrendingGthbRepoQueryVariables>(ListTrendingGthbRepoDocument, options);
        }
export function useListTrendingGthbRepoSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<ListTrendingGthbRepoQuery, ListTrendingGthbRepoQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<ListTrendingGthbRepoQuery, ListTrendingGthbRepoQueryVariables>(ListTrendingGthbRepoDocument, options);
        }
export type ListTrendingGthbRepoQueryHookResult = ReturnType<typeof useListTrendingGthbRepoQuery>;
export type ListTrendingGthbRepoLazyQueryHookResult = ReturnType<typeof useListTrendingGthbRepoLazyQuery>;
export type ListTrendingGthbRepoSuspenseQueryHookResult = ReturnType<typeof useListTrendingGthbRepoSuspenseQuery>;
export type ListTrendingGthbRepoQueryResult = Apollo.QueryResult<ListTrendingGthbRepoQuery, ListTrendingGthbRepoQueryVariables>;
 ...
 * });
 */
export function useListViewGthbReposQuery(baseOptions?: Apollo.QueryHookOptions<ListViewGthbReposQuery, ListViewGthbReposQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<ListViewGthbReposQuery, ListViewGthbReposQueryVariables>(ListViewGthbReposDocument, options);
      }
export function useListViewGthbReposLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<ListViewGthbReposQuery, ListViewGthbReposQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<ListViewGthbReposQuery, ListViewGthbReposQueryVariables>(ListViewGthbReposDocument, options);
        }
export function useListViewGthbReposSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<ListViewGthbReposQuery, ListViewGthbReposQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<ListViewGthbReposQuery, ListViewGthbReposQueryVariables>(ListViewGthbReposDocument, options);
        }
export type ListViewGthbReposQueryHookResult = ReturnType<typeof useListViewGthbReposQuery>;
export type ListViewGthbReposLazyQueryHookResult = ReturnType<typeof useListViewGthbReposLazyQuery>;
export type ListViewGthbReposSuspenseQueryHookResult = ReturnType<typeof useListViewGthbReposSuspenseQuery>;
export type ListViewGthbReposQueryResult = Apollo.QueryResult<ListViewGthbReposQuery, ListViewGthbReposQueryVariables>;
 ...
 * });
 */
export function useSidebarProjCategoriesToProjBookmarksQuery(baseOptions?: Apollo.QueryHookOptions<SidebarProjCategoriesToProjBookmarksQuery, SidebarProjCategoriesToProjBookmarksQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<SidebarProjCategoriesToProjBookmarksQuery, SidebarProjCategoriesToProjBookmarksQueryVariables>(SidebarProjCategoriesToProjBookmarksDocument, options);
      }
export function useSidebarProjCategoriesToProjBookmarksLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<SidebarProjCategoriesToProjBookmarksQuery, SidebarProjCategoriesToProjBookmarksQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<SidebarProjCategoriesToProjBookmarksQuery, SidebarProjCategoriesToProjBookmarksQueryVariables>(SidebarProjCategoriesToProjBookmarksDocument, options);
        }
export function useSidebarProjCategoriesToProjBookmarksSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<SidebarProjCategoriesToProjBookmarksQuery, SidebarProjCategoriesToProjBookmarksQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<SidebarProjCategoriesToProjBookmarksQuery, SidebarProjCategoriesToProjBookmarksQueryVariables>(SidebarProjCategoriesToProjBookmarksDocument, options);
        }
export type SidebarProjCategoriesToProjBookmarksQueryHookResult = ReturnType<typeof useSidebarProjCategoriesToProjBookmarksQuery>;
export type SidebarProjCategoriesToProjBookmarksLazyQueryHookResult = ReturnType<typeof useSidebarProjCategoriesToProjBookmarksLazyQuery>;
export type SidebarProjCategoriesToProjBookmarksSuspenseQueryHookResult = ReturnType<typeof useSidebarProjCategoriesToProjBookmarksSuspenseQuery>;
export type SidebarProjCategoriesToProjBookmarksQueryResult = Apollo.QueryResult<SidebarProjCategoriesToProjBookmarksQuery, SidebarProjCategoriesToProjBookmarksQueryVariables>;