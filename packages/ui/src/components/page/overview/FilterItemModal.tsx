    ...
    <Popover as="div" className="relative inline-block text-left">
      {({ open, close }) => (
        <>
          ...
          <Popover.Button
            className={`text-14 flex h-[30px]  flex-row items-center space-x-2 rounded-[5px] border border-gray-800 px-2 py-1.5 outline-none transition-colors duration-100 hover:bg-gray-700 ${
              value !== '' ? 'bg-gray-850 ' : ''
            }`}
          >
              ...
              <div className="p-2">
                <div className="flex flex-row justify-between">
                  <div className="flex flex-row space-x-2">
                    ...
                    {/* Operator selector */}
                    <Menu as="div">
                      <Menu.Button className="text-14 flex flex-row items-center space-x-1 text-gray-500 outline-none">
                ...
                >
                  <input
                    ...
                    className="bg-gray-850 text-14 w-full rounded px-2 py-1 text-gray-300 outline-none"
                    value={value}
