...
const ProfileDropdownMenu = () => (
  <Menu as="div" className="relative inline-block text-left">
    <div>
      <Menu.Button className="bg-gray-850 text-14 flex h-[30px] w-[30px] flex-row items-center rounded-[5px] border border-gray-800 px-2 py-1.5 transition-colors duration-100 hover:bg-gray-700">
    ...
    <MenuItemsTransition>
      <div className="text-14 absolute left-0 z-20 mt-2 flex flex-col rounded-[5px] bg-gray-700 p-1 shadow-md focus:outline-none">
