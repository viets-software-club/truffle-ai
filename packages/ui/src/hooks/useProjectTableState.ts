...
export const useProjectTableVisibilityState = create<ProjectTableVisibilityState>()(
  persist(
    set => ({
      columnVisibility: {},
      setColumnVisibility: (
        columnVisibility: VisibilityState | ((prevState: VisibilityState) => VisibilityState)
      ) => {
        set(old => ({
          columnVisibility:
