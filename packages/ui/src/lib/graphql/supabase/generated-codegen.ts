...
export type UpdateNotesForGthbRepoMutation = {
	__typename?: 'Mutation';
	updateProjRepoCollection: { __typename?: 'ProjRepoUpdateResponse'; affectedCount: number };
};
...
export type UpdateProjCatNotesByCatTitleMutation = {
	__typename?: 'Mutation';
	updateProjCatCollection: { __typename?: 'ProjCatUpdateResponse'; affectedCount: number };
};
...
export type AllAlgoHnTagQuery = {
	...
	algoHnTagCollection?: {
		...
		edges: Array<{
			__typename?: 'AlgoHnTagEdge';
			node: { __typename?: 'AlgoHnTag'; algoHnTagId: any; internalCreatedAt: any; title: string };
		}>;
	} | null;
};
...
export type AllUserAdminQuery = {
	...
	userAdminCollection?: {
		...
		edges: Array<{
			__typename?: 'UserAdminEdge';
			node: { __typename?: 'UserAdmin'; authUsersId: any; internalCreatedAt: any };
		}>;
	} | null;
};
...
export type DetailViewIssueHistQuery = {
	...
	gthbIssueHistCollection?: {
		...
		edges: Array<{
			__typename?: 'GthbIssueHistEdge';
			node: { __typename?: 'GthbIssueHist'; gthbIssueHistDate: any; amount: any };
		}>;
	} | null;
};
...
export type DetailQuery = {
	...
	fGetGthbRepoByGthbName?: {
		...
		edges: Array<{
			__typename?: 'GthbRepoEdge';
			node: { __typename?: 'GthbRepo'; gthbRepoId: any; gthbRepoDescription?: string | null };
		}>;
	} | null;
	fGetProjRepoByGthbName?: {
		...
		edges: Array<{
			__typename?: 'ProjRepoEdge';
			node: { __typename?: 'ProjRepo'; projRepoId: any; repoEli5?: string | null };
		}>;
	} | null;
...
export type ListCategoriesTitleQuery = {
	...
	projCatCollection?: {
		__typename?: 'ProjCatConnection';
		edges: Array<{ __typename?: 'ProjCatEdge'; node: { __typename?: 'ProjCat'; title: string } }>;
	} | null;
};
			...
			node: {
				...
				gthbRepoAndGthbRepoTopicCollection: {
					...
					edges: Array<{
						...
						node: {
							__typename?: 'GthbRepoAndGthbRepoTopic';
							gthbRepoTopic: { __typename?: 'GthbRepoTopic'; gthbRepoTopicName: string };
						};
					}>;
				};
				gthbRepoAndGthbLangCollection: {
					...
					edges: Array<{
						...
						node: {
							__typename?: 'GthbRepoAndGthbLang';
							gthbLang: { __typename?: 'GthbLang'; gthbLangName: string; color: string };
						};
					}>;
				};
				gthbRepoContrCollection: {
						...
						arguments: [
							{
								...
								value: { kind: 'Variable', name: { kind: 'Name', value: 'ownerLogin' } }
							},
							{
								kind: 'Argument',
	...
	definitions: [
		{
			...
			selectionSet: {
				...
				selections: [
					{
						kind: 'Field',
						name: { kind: 'Name', value: 'fDeleteProjBookmarkOnProjCatByTitleAndGthbRepoId' },
						arguments: [
							{
								kind: 'Argument',
								name: { kind: 'Name', value: 'cattitle' },
								value: { kind: 'Variable', name: { kind: 'Name', value: 'catTitle' } }
							},
							{
								kind: 'Argument',
	...
	definitions: [
		{
			...
			variableDefinitions: [
				{
					kind: 'VariableDefinition',
					variable: { kind: 'Variable', name: { kind: 'Name', value: 'categoryTitle' } },
					type: { kind: 'NamedType', name: { kind: 'Name', value: 'String' } }
				},
				{
					kind: 'VariableDefinition',
	...
	definitions: [
		{
			...
			variableDefinitions: [
				{
					kind: 'VariableDefinition',
					variable: { kind: 'Variable', name: { kind: 'Name', value: 'gthbRepoId' } },
					type: { kind: 'NamedType', name: { kind: 'Name', value: 'BigInt' } }
				},
				{
					kind: 'VariableDefinition',
												...
												fields: [
													{
														kind: 'ObjectField',
														name: { kind: 'Name', value: 'eq' },
														value: { kind: 'Variable', name: { kind: 'Name', value: 'gthbRepoId' } }
													}
												]
											}
										}
										...
										selections: [
											{
												...
												selectionSet: {
													kind: 'SelectionSet',
													selections: [
														{ kind: 'Field', name: { kind: 'Name', value: 'algoHnCommentId' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'internalCreatedAt' } },
														{
															kind: 'Field',
															name: { kind: 'Name', value: 'algoHnCommentObjectId' }
														},
														{ kind: 'Field', name: { kind: 'Name', value: 'algoHnQueryId' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'commentText' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'storyId' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'storyTitle' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'storyUrl' } },
...
} as unknown as DocumentNode<AllAlgoHnCommentQuery, AllAlgoHnCommentQueryVariables>;
	...
	definitions: [
		{
			...
			selectionSet: {
				...
				selections: [
					{
						kind: 'Field',
						name: { kind: 'Name', value: 'algoHnCommentAndAlgoHnTagCollection' },
						selectionSet: {
							kind: 'SelectionSet',
							selections: [
								{
										...
										selections: [
											{
												...
												selectionSet: {
													kind: 'SelectionSet',
													selections: [
														{ kind: 'Field', name: { kind: 'Name', value: 'algoHnTagId' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'algoHnCommentId' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'internalCreatedAt' } }
													]
												}
										...
										selections: [
											{
												...
												selectionSet: {
													kind: 'SelectionSet',
													selections: [
														{ kind: 'Field', name: { kind: 'Name', value: 'algoHnStoryId' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'internalCreatedAt' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'author' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'createdAt' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'algoHnStoryUrl' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'algoHnStoryObjectId' } },
...
} as unknown as DocumentNode<AllAlgoHnStoryAndAlgoHnQuery, AllAlgoHnStoryAndAlgoHnQueryVariables>;
										...
										selections: [
											{
												...
												selectionSet: {
													kind: 'SelectionSet',
													selections: [
														{ kind: 'Field', name: { kind: 'Name', value: 'gthbForkHistId' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'internalCreatedAt' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'gthbRepoId' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'gthbForkHistDate' } },
...
} as unknown as DocumentNode<AllGthbForkHistQuery, AllGthbForkHistQueryVariables>;
										...
										selections: [
											{
												...
												selectionSet: {
													kind: 'SelectionSet',
													selections: [
														{ kind: 'Field', name: { kind: 'Name', value: 'gthbIssueHistId' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'internalCreatedAt' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'gthbRepoId' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'gthbIssueHistDate' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'amount' } }
													]
												}
											}
...
} as unknown as DocumentNode<AllGthbIssueHistQuery, AllGthbIssueHistQueryVariables>;
										...
										selections: [
											{
												...
												selectionSet: {
													kind: 'SelectionSet',
													selections: [
														{ kind: 'Field', name: { kind: 'Name', value: 'gthbLangId' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'internalCreatedAt' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'color' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'gthbLangName' } }
													]
												}
											}
										]
										...
										selections: [
											{
												...
												selectionSet: {
													kind: 'SelectionSet',
													selections: [
														{ kind: 'Field', name: { kind: 'Name', value: 'gthbOrgId' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'internalCreatedAt' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'createdAt' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'gthbOrgDescription' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'descriptionHtml' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'email' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'gthbOrgName' } },
										...
										selections: [
											{
												...
												selectionSet: {
													kind: 'SelectionSet',
													selections: [
														{ kind: 'Field', name: { kind: 'Name', value: 'gthbOwnerId' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'internalCreatedAt' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'gthbOwnerType' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'avatarUrl' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'gthbOwnerLogin' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'gthbOwnerUrl' } },
														{
															kind: 'Field',
															name: { kind: 'Name', value: 'repositoriesTotalCount' }
														}
													]
												}
											}
										...
										selections: [
											{
												...
												selectionSet: {
													...
													selections: [
														...
														{ kind: 'Field', name: { kind: 'Name', value: 'isInOrganization' } },
														...
														{ kind: 'Field', name: { kind: 'Name', value: 'gthbRepoUrl' } },
...
} as unknown as DocumentNode<AllGthbRepoAndGthbLangQuery, AllGthbRepoAndGthbLangQueryVariables>;
										...
										selections: [
											{
												...
												selectionSet: {
													...
													selections: [
														{ kind: 'Field', name: { kind: 'Name', value: 'gthbRepoId' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'gthbRepoTopicId' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'internalCreatedAt' } }
													]
												}
											}
										...
										selections: [
											{
												...
												selectionSet: {
													...
													selections: [
														{ kind: 'Field', name: { kind: 'Name', value: 'gthbRepoId' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'gthbOwnerId' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'contributions' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'internalCreatedAt' } }
													]
												}
											}
...
} as unknown as DocumentNode<AllGthbRepoContributorQuery, AllGthbRepoContributorQueryVariables>;
										...
										selections: [
											{
												...
												selectionSet: {
													...
													selections: [
														{ kind: 'Field', name: { kind: 'Name', value: 'gthbRepoTopicId' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'internalCreatedAt' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'gthbRepoTopicName' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'stargazerCount' } }
													]
												}
											}
...
} as unknown as DocumentNode<AllGthbRepoTopicQuery, AllGthbRepoTopicQueryVariables>;
										...
										selections: [
											{
												...
												selectionSet: {
													kind: 'SelectionSet',
													selections: [
														{ kind: 'Field', name: { kind: 'Name', value: 'gthbStarHistId' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'internalCreatedAt' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'gthbRepoId' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'gthbStarHistDate' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'amount' } }
													]
												}
											}
...
} as unknown as DocumentNode<AllGthbStarHistQuery, AllGthbStarHistQueryVariables>;
										...
										selections: [
											{
												...
												selectionSet: {
													kind: 'SelectionSet',
													selections: [
														{ kind: 'Field', name: { kind: 'Name', value: 'gthbTrendingId' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'gthbRepoId' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'internalCreatedAt' } },
...
} as unknown as DocumentNode<AllGthbTrendingQuery, AllGthbTrendingQueryVariables>;
										...
										selections: [
											{
												...
												selectionSet: {
													kind: 'SelectionSet',
													selections: [
														{ kind: 'Field', name: { kind: 'Name', value: 'gthbUserId' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'internalCreatedAt' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'bio' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'bioHtml' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'company' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'companyHtml' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'createdAt' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'email' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'followersTotalCount' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'gthbUserName' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'twitterUsername' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'websiteUrl' } }
													]
												}
										...
										selections: [
											{
												...
												selectionSet: {
													kind: 'SelectionSet',
													selections: [
														{ kind: 'Field', name: { kind: 'Name', value: 'projBookmarkId' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'internalCreatedAt' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'projRepoId' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'authUsersId' } },
...
} as unknown as DocumentNode<AllProjBookmarkQuery, AllProjBookmarkQueryVariables>;
										...
										selections: [
											{
												...
												selectionSet: {
													kind: 'SelectionSet',
													selections: [
														{ kind: 'Field', name: { kind: 'Name', value: 'projCatId' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'internalCreatedAt' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'title' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'authUsersId' } },
										...
										selections: [
											{
												...
												selectionSet: {
													kind: 'SelectionSet',
													selections: [
														{ kind: 'Field', name: { kind: 'Name', value: 'projClassifierId' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'internalCreatedAt' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'classifier' } }
													]
												}
											}
										]
...
} as unknown as DocumentNode<AllProjClassifierQuery, AllProjClassifierQueryVariables>;
	...
	definitions: [
		{
			...
			selectionSet: {
				...
				selections: [
					{
						kind: 'Field',
						name: { kind: 'Name', value: 'projRepoAndProjClassifierCollection' },
						selectionSet: {
							kind: 'SelectionSet',
							selections: [
								{
	...
	definitions: [
		{
			...
			selectionSet: {
				...
				selections: [
					{
						kind: 'Field',
						name: { kind: 'Name', value: 'projRepoAndSbotLinCompanyCollection' },
						selectionSet: {
							kind: 'SelectionSet',
							selections: [
								{
										...
										selections: [
											{
												...
												selectionSet: {
													...
													selections: [
														{ kind: 'Field', name: { kind: 'Name', value: 'projRepoId' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'sbotLinCompanyId' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'internalCreatedAt' } }
													]
												}
											}
										...
										selections: [
											{
												...
												selectionSet: {
													...
													selections: [
														{ kind: 'Field', name: { kind: 'Name', value: 'projRepoId' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'sbotLinProfileId' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'internalCreatedAt' } }
													]
												}
											}
										...
										selections: [
											{
												...
												selectionSet: {
													...
													selections: [
														{ kind: 'Field', name: { kind: 'Name', value: 'projRepoId' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'algoHnEli5' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'repoEli5' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'internalCreatedAt' } }
													]
												}
											}
...
} as unknown as DocumentNode<AllProjRepoMetadataQuery, AllProjRepoMetadataQueryVariables>;
										...
										selections: [
											{
												...
												selectionSet: {
													...
													selections: [
														{ kind: 'Field', name: { kind: 'Name', value: 'sbotLinCompanyId' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'internalCreatedAt' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'sbotLinCompanyUrl' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'sbotLinCompanyName' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'sphere' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'followers' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'logo' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'sbotLinCompanyImage' } },
														{
															kind: 'Field',
															name: { kind: 'Name', value: 'employeesAmountInLinkedin' }
														},
														{ kind: 'Field', name: { kind: 'Name', value: 'about' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'website' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'headquarters' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'sbotLinCompanyType' } }
													]
												}
											}
										]
...
} as unknown as DocumentNode<AllSbotLinCompanyQuery, AllSbotLinCompanyQueryVariables>;
										...
										selections: [
											{
												...
												selectionSet: {
													...
													selections: [
														{ kind: 'Field', name: { kind: 'Name', value: 'sbotLinProfileId' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'internalCreatedAt' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'sbotLinProfileUrl' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'sbotLinProfileName' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'position' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'currentCompanyName' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'currentCompanyLink' } },
														...
														{
															kind: 'Field',
															name: { kind: 'Name', value: 'sbotLinProfileFollowing' }
														},
														{ kind: 'Field', name: { kind: 'Name', value: 'educationDetails' } }
													]
												}
											}
										]
...
} as unknown as DocumentNode<AllSbotLinProfileQuery, AllSbotLinProfileQueryVariables>;
										...
										selections: [
											{
												...
												selectionSet: {
													kind: 'SelectionSet',
													selections: [
														{ kind: 'Field', name: { kind: 'Name', value: 'userApiKeyId' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'internalCreatedAt' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'userApiKey' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'authUsersId' } }
													]
												}
											}
										...
										selections: [
											{
												...
												selectionSet: {
													kind: 'SelectionSet',
													selections: [
														{ kind: 'Field', name: { kind: 'Name', value: 'userWhitelistId' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'internalCreatedAt' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'kind' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'userWhitelistValue' } }
													]
												}
											}
										]
...
} as unknown as DocumentNode<AllUserWhitelistQuery, AllUserWhitelistQueryVariables>;
...
} as unknown as DocumentNode<CompareListByCategoryIdQuery, CompareListByCategoryIdQueryVariables>;
...
} as unknown as DocumentNode<DetailViewForkHistQuery, DetailViewForkHistQueryVariables>;
...
} as unknown as DocumentNode<DetailViewIssueHistQuery, DetailViewIssueHistQueryVariables>;
...
} as unknown as DocumentNode<DetailViewProjRepoTopQuery, DetailViewProjRepoTopQueryVariables>;
...
} as unknown as DocumentNode<DetailViewStarHistQuery, DetailViewStarHistQueryVariables>;
...
} as unknown as DocumentNode<DetailViewProjRepoTop2Query, DetailViewProjRepoTop2QueryVariables>;
...
} as unknown as DocumentNode<ListViewGthbReposQuery, ListViewGthbReposQueryVariables>;
										...
										selections: [
											{
												...
												selectionSet: {
													kind: 'SelectionSet',
													selections: [{ kind: 'Field', name: { kind: 'Name', value: 'note' } }]
												}
											}
										]
									}
...
} as unknown as DocumentNode<HackernewsEli5ByGthbNameQuery, HackernewsEli5ByGthbNameQueryVariables>;
...
} as unknown as DocumentNode<ListCategoriesTitleQuery, ListCategoriesTitleQueryVariables>;
																			...
																			selections: [
																				{
																					...
																					selectionSet: {
																						...
																						selections: [
																							{
																								kind: 'Field',
																								name: { kind: 'Name', value: 'gthbRepoTopic' },
																								selectionSet: {
																									kind: 'SelectionSet',
																									selections: [
																										{
...
} as unknown as DocumentNode<RepoSidebarByGthbRepoIdQuery, RepoSidebarByGthbRepoIdQueryVariables>;
