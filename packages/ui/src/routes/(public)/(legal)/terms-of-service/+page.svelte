...
<header class="mb-4 text-sm">
	<h1 class="text-3xl mb-1 md:text-5xl font-medium border-b-gray-400 md:mb-3">Terms of Service</h1>
	<Separator />
	<div class="pt-4 pb-2">
...
<section>
	<p>
		The following terms and conditions govern your use of our website. By using this web site, you
		agree to these terms and conditions, which we may modify from time-to-time as posted on this web
		site.
	</p>
	<section>
		<h2>1. Copyrights; Other Intellectual Property</h2>
		<p>
			Unless otherwise noted, all information and content posted on our website is property of La
			Famiglia, including graphics, icons and our website's overall appearance.
		</p>
	</section>
	<section>
		<h2>2. Website Links</h2>
		<p>
			We may have links between our website and websites / content of third parties. For purposes of
			...
			respective websites, contents, or their operators.
		</p>
	</section>
	<section>
		<h2>3. Illegal activity</h2>
		<p>
			You agree not to use our website for any illegal activity or to transmit any material that is
			...
			that infringe upon the freedom of others.
		</p>
	</section>
</section>
