...
const Header: React.FC<HeaderProps> = ({ text }) => {
  ...
  return (
    <h1 id={headerId} className="py-1 pb-4 text-20 font-medium text-gray-200">
      {text}
    </h1>
  )
}
...
export const HeaderTwo: React.FC<HeaderProps> = ({ text }) => {
  const headerId = generateHeaderId(text)
  return (
    <h2 id={headerId} className="py-1 text-18 font-medium text-gray-300">
      {text}
    </h2>
  )
}
...
export const HeaderThree: React.FC<HeaderProps> = ({ text }) => {
  const headerId = generateHeaderId(text)
  return (
    <h3 id={headerId} className="py-1 pt-2 text-16 font-medium text-gray-300">
      {text}
    </h3>
  )
}
